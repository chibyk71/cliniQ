...
export let impressionOptions:ApexOptions = {
    series: [
        {
            name: 'Orders',
            type: 'area',
...
export let meterOneOption:ApexOptions = {
    series: [44, 55, 41],
    chart: {
        width: 160,
        height: 200,
...
export let meterTwoOption:ApexOptions = {
    series: [44, 55],
    chart: {
        width: "100%",
        height: 200,
...
export const renderChart= (el:HTMLElement, options:ApexOptions) => {
